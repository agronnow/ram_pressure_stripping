...
#if NDIM==2
              PoissMean = PoissMean*4.0*R_cut/3.0
#endif
...
!  endif
  ...
  call subgrid_average_SN(xSN,vol_gas,dq,ekBlast,indSN,nSN)
...
!################################################################
!################################################################
subroutine subgrid_average_SN(xSN,vol_gas,dq,ekBlast,ind_blast,nSN)
  use pm_commons
  use amr_commons
  use hydro_commons
  use mpi_mod
